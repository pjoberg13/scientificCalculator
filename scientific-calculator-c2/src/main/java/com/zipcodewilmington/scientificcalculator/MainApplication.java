    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            switch (i) {
                ...
                case 2:
                    ...
                    switch (scientificOperationMenu) {
                        ...
                        case 11:
                            ...
                            Console.println(String.valueOf(factorial((int) input)));
                            break;
                        default:
                ...
                case 4:
                    Console.println("What would you like to convert your value to?");
                    Integer decimalConversionMenu = Console.getIntegerInput("decimal: 1\nbinary 2\noctal 3\nhexadecimal 4");

                    switch (decimalConversionMenu) {
                        case 1:
                            //To decimal
                            Display.getToDecimalString();
                            break;

                        case 2:
                            //To binary
                            Display.getToBinaryString();

                        case 3:
                            //To octal
                            Display.getToOctalString();
